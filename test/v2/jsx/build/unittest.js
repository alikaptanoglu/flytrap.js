	...
	function() {
		return React.createClass({
			...
			componentDidMount: function() {
		  	...
		  	render: function() {
			    return (
			      	React.createElement("div", {className: this.state.status + ' test-node'}, 
			      		React.createElement("span", null, this.props.title), 
			      		React.createElement("div", {style: {visibility: this.state.status == 'incomplete' ? 'visible' : 'hidden', position: 'relative'}}, 
